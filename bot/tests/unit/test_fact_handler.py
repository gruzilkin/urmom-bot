...
class TestFactHandlerIntegration(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_remember_fact_for_new_user(self):
        ...
        # AI call now needed for confirmation message generation
    ...
    async def test_remember_fact_with_existing_memory(self):
        ...
        self.mock_ai_client.generate_content = AsyncMock(
            return_value=MemoryUpdate(
                updated_memory="they like chocolate and they are a developer",
                confirmation_message="I'll remember that they are a developer.",
            )
        )
        ...
        self.mock_store.save_user_facts.assert_awaited_once_with(
            67890, 12345, "they like chocolate and they are a developer"
        )
    ...
    async def test_forget_fact_not_found(self):
        ...
        self.mock_ai_client.generate_content = AsyncMock(
            return_value=MemoryForget(
                updated_memory="they like chocolate",
                fact_found=False,
                confirmation_message="I couldn't find that information about broccoli in my memory.",
            )
        )
    ...
    async def test_forget_fact_found(self):
        ...
        self.mock_ai_client.generate_content = AsyncMock(
            return_value=MemoryForget(
                updated_memory="they are a developer",
                fact_found=True,
                confirmation_message="I've forgotten that they like chocolate.",
            )
        )
