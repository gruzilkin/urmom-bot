...
class MessageGraph:
    ...
    async def to_chronological_conversation(
        self, discord_to_message_node_func: Callable[[nextcord.Message], Awaitable["MessageNode"]]
...
class ConversationGraphBuilder:
    ...
    async def build_conversation_graph(
        ...
        discord_to_message_node_func: Callable[[nextcord.Message], Awaitable["MessageNode"]],
    ) -> list[ConversationMessage]:
        """
