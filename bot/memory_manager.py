...
class MemoryManager:
    ...
    async def get_memories(self, guild_id: int, user_id: int) -> str | None:
        ...
        # Multiple sources exist - use AI to merge them intelligently
        return await self._merge_context(guild_id, user_id, facts, current_day_summary, historical_summary)
